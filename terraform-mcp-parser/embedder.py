...
def summary_to_text(summary: dict) -> str:
    ...
    if summary.get("typical_use_cases"):
        parts.append("Typical use cases: " + "; ".join(summary["typical_use_cases"]))
    elif summary.get("typical_use_case"):
        # Backward compat with summaries generated by the older prompt.
